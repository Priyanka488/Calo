        ...
        if (requestCode == RC_BARCODE_CAPTURE) {
            if (resultCode == CommonStatusCodes.SUCCESS) {
                if (data != null) {
                   ...
                   // Toast.makeText(BarcodeMainActivity.this, barcode.displayValue, Toast.LENGTH_SHORT).show();
                    Intent intent = new Intent(BarcodeMainActivity.this,TestActivity.class);
                    intent.putExtra("barcodeString", barcode.displayValue);
